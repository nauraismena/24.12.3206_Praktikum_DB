        ...
        <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y border-t">
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-6">
                                <p class="font-medium text-slate-700">Malam Jazz 2024</p>
                            </td>
                        ...
                        <tr class="hover:bg-slate-50/50 transition">
                            <td class="px-8 py-6">
                                <span class="font-mono font-bold text-indigo-600 bg-indigo-50 px-3 py-1 rounded-lg text-sm">#TRX-99209</span>
                            </td>
                            <td class="px-8 py-6">
                            ...
                            <td class="px-8 py-6">
                                <p class="font-medium text-slate-700">Lokakarya AI & Masa Depan</p>
                            </td>
                            <td class="px-8 py-6 text-sm text-slate-500">
                                26 Mar 2024, 15:20
                            </td>
                        ...
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-8 py-6">
                                <span class="px-3 py-1 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold uppercase ring-1 ring-slate-200">Bebas</span>
                            </td>
                            <td class="px-8 py-6 text-right font-black text-slate-900">
                                Rp 0
                            </td>
            ...
            <div class="px-8 py-6 bg-slate-50/50 border-t flex justify-between items-center">
                ...
                <div class="flex gap-2">
                    ...
                    <button class="px-4 py-2 border rounded-xl hover:bg-white transition text-sm font-bold">Berikutnya</button>
                </div>
            </div>
        </div>
    </main>
