...
<nav class="flex-1 space-y-2">
    ...
    <a href="{{ route('admin.dashboard') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition hover:bg-indigo-800 {{ request()->routeIs('admin.dashboard') ? 'bg-indigo-800 text-white' : '' }}">
    ...
    <a href="{{ route('admin.events.index') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition hover:bg-indigo-800 {{ request()->routeIs('admin.events.*') ? 'bg-indigo-800 text-white' : '' }}">
    ...
    <a href="{{ route('admin.categories.index') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition hover:bg-indigo-800 {{ request()->routeIs('admin.categories.*') ? 'bg-indigo-800 text-white' : '' }}">

        <svg class="w-5 h-5 text-indigo-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M7 7h.01M7 3h5c.512 0 1.023.195 1.414.586l6 6a2 2 0 010 2.828l-4.172 4.172a2 2 0 01-2.828 0l-6-6A2 2 0 016 9V4a1 1 0 011-1z">
            </path>
        </svg>
    ...
    <a href="{{ route('admin.transactions') }}"
       class="flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition hover:bg-indigo-800 {{ request()->routeIs('admin.transactions') ? 'bg-indigo-800 text-white' : '' }}">
